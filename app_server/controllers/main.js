...
module.exports.get_emdashboard = function(request,result)
{
	sendPage('./app_server/views/employmentdashboard.html',result)
};
module.exports.get_eddashboard = function(request,result)
{
	sendPage('./app_server/views/educationdashboard.html',result)
};
